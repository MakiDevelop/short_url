        ...
        <div class="card-body">
            <div class="col-sm-12 text-end">
                ...
                <div class="d-inline p-2">
                    ...
                    <button type="button" id="qrcode" class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapseQRCode" aria-expanded="false" aria-controls="collapseQRCode">QRCode</button>
                </div>
            </div>
